describe('bouncyDancer', function() {
  ...
  it('should have a step function that makes its node slide up', function() {
    sinon.spy(bouncyDancer.$node, 'slideUp'); // should it be "bounce" instead?
    bouncyDancer.step();
    expect(bouncyDancer.$node.slideUp.called).to.be.true;
  });

  it('should have a step function that makes its node slideDown', function() {
    sinon.spy(bouncyDancer.$node, 'slideDown'); // should it be "bounce" instead?
    bouncyDancer.step();
